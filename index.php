				...
				<div class="row">
					<div class="col-sm-6 text-center">
						<div class="featured">
							...
							<div class="desc">
								<h2><a href="#">Giày Nam</a></h2>
							</div>
						</div>
					</div>
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="#" class="featured-img" style="background-image: url(images/item-10.jpeg);"></a>
							<div class="desc">
								<h2><a href="#">Giày Nữ</a></h2>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p><a href="#" class="btn btn-primary btn-lg">Tất Cả Các Sản Phẩm</a></p>
					</div>
				</div>
			</div>
		</div>
