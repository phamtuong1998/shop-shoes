		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
				   			...
				   			<div class="col-sm-6 offset-sm-3 text-center slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
					   					...
					   					<p><a href="product-detail.php" class="btn btn-primary">Shop Collection</a></p>
				   					</div>
				   				</div>
				   			</div>
				   		</div>
			   	...
			   	<li style="background-image: url(images/img_bg_2.jpg);width:50% !important;">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-sm-6 offset-sm-3 text-center slider-text">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 text-center">
						<h2 class="intro">Hãy lựa chọn những đôi giày đẹp nhất, Để khoe cá tính của bạn. </h2>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="product-detail.php" class="featured-img" style="background-image: url(images/men.jpg);"></a>
							<div class="desc">
								<h2><a href="product-detail.php">Giày Nam</a></h2>
							</div>
						</div>
					</div>
					<div class="col-sm-6 text-center">
						<div class="featured">
							<a href="product-detail.php" class="featured-img" style="background-image: url(images/item-10.jpeg);"></a>
							<div class="desc">
								<h2><a href="product-detail.php">Giày Nữ</a></h2>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row row-pb-md">
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="product-detail.php" class="prod-img">
								<img src="images/item-1.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
								<h2><a href="product-detail.php">Women's Boots Shoes Maca</a></h2>
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<div class="desc">
								<h2><a href="product-detail.php">Women's Minam Meaghan</a></h2>
								<span class="price">$139.00</span>
							</div>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<div class="desc">
								<h2><a href="product-detail.php">Men's Taja Commissioner</a></h2>
								<span class="price">$139.00</span>
							</div>
						</div>
					</div>
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							...
							<div class="desc">
								<h2><a href="product-detail.php">Russ Men's Sneakers</a></h2>
								<span class="price">$139.00</span>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						<p><a href="product-detail.php" class="btn btn-primary btn-lg">Tất Cả Các Sản Phẩm</a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="colorlib-partner">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col partner-col text-center">
						<img src="images/brand-4.png" class="img-fluid" alt="Free html4 bootstrap 4 template">
					</div>
					<div class="col partner-col text-center">
